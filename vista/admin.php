...
<body>
    ...
    <nav>
        ...
        <h1>Hola, Bievenido <?php 
        if ($_SESSION["nombre"]=="Director/a") {
           echo "Director/a";
        }
        else {
            echo $_SESSION["nombre"][0][0]." ".$_SESSION["nombre"][0][1];
        }
        ?></h1>
    </nav>
    ...
    <h3 style='text-align:center;'>¿Esta seguro/a que desea cancelar esta solicitud?</h3><br>
    ...
    <form action="../control/c_prestamoEntregado.php" method="post" id='form_entregado' name='form_entregado'>
        ...
        <input type="text" id='cedula_entregado_solicitante' name='cedula_entregado_solicitante' hidden>
        <input type="text" placeholder='Observacion' maxlength='70' id='observacion' name='observacion'>
    </form><br><br>
    ...
    <div class='submenu'>
        <nav>
        <div id='boton_usuario'>Usuarios</div>
        <div id='boton_grupo'>Grupos</div>
        <div id='boton_equipo'>Objetos Individuales</div>
        <div id='clase'>Clases</div>
        <div id='actividad'>Actividades</div>
        <div id='salon'>Salones/Aulas</div>
    ...
    <form action="../control/c_registrar.php" name="registrar" id="registrar" method='POST'>
        <div id='registrar_usuario_container' class='container'>
            <h3 style='text-align:center'>Registrar Usuario</h3>
            <div class='input_container'>
                <label for="cedula_usuario">Cedula</label><br>
                <input type="text" id='cedula_usuario' name='cedula_usuario' class='registrar_input' maxlength='30'>
                <input type="checkbox" class='checkbox' onclick='Check(0,this,"cedula_usuario")'>
            </div><br>
            <div class='input_container'>
                <label for="nombre_usuario">Nombre</label><br>
                <input type="text" id='nombre_usuario' name='nombre_usuario' class='registrar_input' maxlength='40'>
                <input type="checkbox" class='checkbox' onclick='Check(1,this,"nombre_usuario")'>
            </div><br>
            <div class='input_container'>
                <label for="apellido_usuario">Apellido</label><br>
                <input type="text" id='apellido_usuario' name='apellido_usuario' class='registrar_input' maxlength='40'>
                <input type="checkbox" class='checkbox' onclick='Check(2,this,"apellido_usuario")'>
            </div><br>
            <div class='input_container'>
                <label for="rol">Rol</label><br>
                <select name="rol" id="rol" class='registrar_input'>
                    <option value="">Seleccione</option>
                    <option value="administrador">Administrador</option>
                    <option value="usuario">Usuario</option>
                    <option value="almacenista">Almacenista</option>
                </select>
                <input type="checkbox" class='checkbox' onclick='Check(3,this,"rol")'>
            </div><br>
            <div class='button_container'>
                <button type='button' style='' onclick='Registrar()' id='boton-registrar'>Registrar</button>
                <button type='button' style='left: 50px;' class='cerrar'>Cerrar</button>
            </div>
            <input type="text" id='cedula_original' name='cedula_original' style='position:absolute;' class='registrar_input' hidden>
        </div>
    </form>
    ...
    <div class='tabla_usuario container_tabla' style='display: none;'>
    <a href="userPDF.php" class='pdf' style='position:absolute;height:30px;text-align:center;padding-top:7px;left:900px;
    bottom:5px;'>Descargar PDF</a>
        <div class='tabla' id='tabla_user'style='grid-template-columns: 150px 150px 150px 130px 120px 120px 120px 120px 120px;'>
            <div class='titulo' maxlength='40'>Cedula</div>
            <div class='titulo' maxlength='50'>Nombre</div>
            <div class='titulo' maxlength='50'>Apellido</div>
            <div class='titulo' maxlength='70'>Rol</div>
            ...
            while ($fila>$contador){
                for ($i=0; $i < 5; $i++) { 
                    if ($val[$contador][4]==0 && $i==4) {
                        echo "<div class='contenido'>Inactivo</div>";
                    }
                    if ($val[$contador][4]==1 && $i==4) {
                        echo "<div class='contenido'>Activo</div>";
                    }
                    else if($i!=4) {
                        echo "<div class='contenido'>".$val[$contador][$i]."</div>";
                    }
                   
                }
                print_r("<button type='button' class='botones-tabla' onclick='Update(`".$val[$contador][0]."`,`".$val[$contador][1]."`,`".$val[$contador][2]."`,`".$val[$contador][3]."`)'>Modificar</button>");
                print_r("<button type='button' class='botones-tabla' onclick='Eliminar(`".$val[$contador][0]."`)'>Eliminar</button>");
                
                if ($val[$contador][4]==0) {
                    print_r("<button type='button' class='botones-tabla' onclick='State(`".$val[$contador][0]."`,`1`)'>Activar</button>");
                }
                else {
                    print_r("<button type='button' class='botones-tabla' onclick='State(`".$val[$contador][0]."`,`0`)'>Desactivar</button>");
                } 
                print_r("<button type='button' class='botones-tabla' onclick='PDFusuario(`".$val[$contador][0]."`)' title='Descargar PDF de este usuario'>PDF</button>");               
                $contador=$contador+1;
        ...
        <button type='button' class='agregar'>Agregar Usuario</button>
    </div>
    ...
    <form action="../control/c_registrar_equipo.php" name="registrar_equipo" id="registrar_equipo" method='POST'>
        ...
        <div id='registrar_equipos_container' class='container' style='top:-40%;'>
            <h3 style='text-align:center'>Registrar Equipo</h3>
            <div class='input_container'>
            ...
            <div class='input_container'>
                ...
                <select name="estado" id="estado" class='registrar_input'>
                    ...
                    <option value="prestamo" hidden>Prestado</option>
                </select>
            ...
            <div class='input_container'>
                ...
                <select name="clase_select" id="clase_select" class='registrar_input'>
                    ...
                    $contador=0;
                    while ($fila>$contador){
                        echo "<option value='".$clase[$contador][0]."'>".$clase[$contador][1]."</option>";
                        $contador=$contador+1;
                    }
                    ?>
                </select>
    ...
    <a href="objetosPDF.php" class='pdf' style='position:absolute;height:30px;text-align:center;padding-top:7px;left:900px;bottom:5px;'>Descargar PDF</a>
        <div class='tabla' style='grid-template-columns:120px 120px 200px 130px 150px 150px 120px 120px'>
            ...
            <div class='titulo' maxlength='70'>Clase</div>
            <div></div>
            <div></div>
            <?php
            $fila=count($equipo);
            ...
            while ($fila>$contador){
                ...
                for ($i=0; $i < 6; $i++) { 
                    if ($i==4) {
                        ...
                        echo "<div class='contenido'>".$valorclase."</div>";
                    }
                    else {
                ...
                print_r("<button type='button' class='botones-tabla' onclick='UpdateEquipos(`".$equipo[$contador][0]."`,`".$equipo[$contador][1]."`,`".$equipo[$contador][2]."`,`".$equipo[$contador][3]."`,`".$equipo[$contador][4]."`,`".$equipo[$contador][5]."`)'>Modificar</button>");
                print_r("<button type='button' class='botones-tabla' onclick='EliminarEquipos(`".$equipo[$contador][0]."`)'>Eliminar</button>");
                $contador=$contador+1;
            }
            
            ?>
        </div>
        <button type='button' class='agregar_equipo'>Agregar Equipo</button>
    </div>
    ...
    <form action="../control/c_registrar_grupo.php" name="registrar_grupo" id="registrar_grupo" method='POST'>
        <div id='registrar_grupo_container' class='container' style='top:10%;'>
            <h3 style='text-align:center'>Registrar Grupo</h3>
            <div class='input_container'>
    ...
    <a href="grupoPDF.php" class='pdf' style='position:absolute;height:30px;text-align:center;padding-top:7px;left:850px;bottom:5px;'>Descargar PDF</a>
        <div class='tabla' style='grid-template-columns: 150px 300px 300px 150px 150px'>
            ...
            while ($fila>$contador){
                ...
                print_r("<button type='button' class='botones-tabla' onclick='EliminarGrupo(`".$grupo[$contador][0]."`)'>Eliminar</button>");
                $contador=$contador+1;
            }
            
            ?>
        </div>
        <button type='button' class='agregar_grupo'>Agregar Grupo</button>
    </div>
    ...
    <h2 style='text-align:center;font-size:32px;'>Solicitudes Pendientes</h2>
        <div class='tabla'>
            ...
            while ($fila>$contador){
                ...
                print_r("<button type='button' class='botones-tabla' onclick='PDFUsuarioPendiente(`".$prestamoPendiente[$contador][13]."`)' title='Descargar el formato de solicitudes de este usuario')'>PDF</button>");             
                $contador=$contador+1;
            }
            ?>
        </div>
    ...
    <form action="../control/c_registrar_actividad.php" name="actividad_form" id="actividad_form" method='POST'>
        <div id='actividad_form_container' class='container' style='top:5%;width:350px'>
        <h3 style='text-align:center'>Registrar Actividad</h3>
            <div class='input_container'>
                <label for="actividad_inf">Actividad</label><br>
                <input type="text" id='actividad_inf' name='actividad_inf' class='registrar_input' maxlength='70' style='width:89%'>
                <input type="checkbox" class='checkbox' onclick='Check(1,this,"actividad_inf")'>
                <input type="text" id='id' name='id' hidden>
            </div><br>
            <div class='button_container'>
                <button type='button' style='' onclick='RegistrarActividad()' id='boton-registrar'>Registrar</button>
                <button type='button' style='left: 180px;' class='cerrar_actividad'>Cerrar</button>
            </div>
        </div>
    </form>
    <div class='tabla_actividad container_tabla' style='display: none;left:140px'>
        <div class='tabla' style='grid-template-columns: 150px 150px 150px'>
            <div class='titulo' maxlength='50'>Actividad</div>
            <div></div>
            <div></div>
            <?php
            $fila=count($actividad);
            $contador=0;
            while ($fila>$contador){
                for ($i=1; $i < 2; $i++) { 
                     echo "<div class='contenido'>".$actividad[$contador][$i]."</div>";
                    
                }
                print_r("<button type='button' class='botones-tabla' onclick='UpdateActividad(`".$actividad[$contador][0]."`,`".$actividad[$contador][1]."`)'>Modificar</button>");
                print_r("<button type='button' class='botones-tabla' onclick='EliminarActividad(`".$actividad[$contador][0]."`)'>Eliminar</button>");
                $contador=$contador+1;
            }
            
            ?>
        </div>
        <button type='button' class='agregar_actividad'>Agregar Actividad</button>
    </div>
    ...
    <form action="../control/c_registrarClase.php" name="clase_form" id="clase_form" method='POST'>
        <div id='clase_form_container' class='container' style='top:5%;width:350px'>
        <h3 style='text-align:center'>Registrar Clase</h3>
            <div class='input_container'>
                <label for="clase_inf">Clase</label><br>
                <input type="text" id='clase_inf' name='clase_inf' class='registrar_input' maxlength='70' style='width:89%'>
                <input type="checkbox" class='checkbox' onclick='Check(1,this,"clase_inf")'>
                <input type="text" id='id_clase' name='id_clase' hidden>
            </div><br>
            <div class='button_container'>
                <button type='button' style='' onclick='RegistrarClase()' id='boton-registrar'>Registrar</button>
                <button type='button' style='left: 180px;' class='cerrar_clase' >Cerrar</button>
            </div>
        </div>
    </form>
    <div class='tabla_clase container_tabla' style='display: none;left:140px'>
    <a href="clasePDF.php" class='pdf' style='position:absolute;height:30px;text-align:center;padding-top:7px;margin-left:470px'>Descargar PDF</a>
        <div class='tabla' style='grid-template-columns: 150px 120px 120px 120px 120px 120px 120px'>
            <div class='titulo' maxlength='50'>Clase</div>
            <div class='titulo' maxlength='40'>Objetos en Buen Estado</div>
            <div class='titulo' maxlength='50'>Objetos Deteriorados</div>
            <div class='titulo' maxlength='50'>Objetos En Prestamo</div>
            <div class='titulo' maxlength='50'>Objetos en Total</div>
            <div></div>
            <div></div>
            <?php
            $fila=count($clase);
            ...
            while ($fila>$contador){
                ...
                for ($i=1; $i < 2; $i++) { 
                     echo "<div class='contenido'>".$clase[$contador][$i]."</div>";
                    
                }
                echo "<div class='contenido'>".$equiposbien."</div>";
                echo "<div class='contenido'>".$equipodeteriorado."</div>";
                echo "<div class='contenido'>".$equipoprestado."</div>";
                echo "<div class='contenido'>".$equipototal."</div>";
                print_r("<button type='button' class='botones-tabla' onclick='UpdateClase(`".$clase[$contador][0]."`,`".$clase[$contador][1]."`)'>Modificar</button>");
                print_r("<button type='button' class='botones-tabla' onclick='EliminarClase(`".$clase[$contador][0]."`)'>Eliminar</button>");
                $contador=$contador+1;
            }
            
            ?>
        </div>
        <button type='button' class='agregar_clase'>Agregar Clase</button>
    </div>
    ...
    <form action="../control/c_registrar_salon.php" name="salon_form" id="salon_form" method='POST'>
        <div id='salon_form_container' class='container' style='top:5%;width:350px'>
        <h3 style='text-align:center'>Registrar Salon</h3>
            <div class='input_container'>
                <label for="salon_inf">Salon</label><br>
                <input type="text" id='salon_inf' name='salon_inf' class='registrar_input' maxlength='70' style='width:89%'>
                <input type="checkbox" class='checkbox' onclick='Check(1,this,"salon_inf")'>
                <input type="text" id='id_salon' name='id_salon' hidden>
            </div><br>
            <div class='button_container'>
                <button type='button' style='' onclick='RegistrarSalon()' id='boton-registrar'>Registrar</button>
                <button type='button' style='left: 180px;' class='cerrar_salon'>Cerrar</button>
            </div>
        </div>
    </form>
    <div class='tabla_salon container_tabla' style='display: none;left:140px'>
        <div class='tabla' style='grid-template-columns: 150px 150px 150px'>
            <div class='titulo' maxlength='50'>Salon</div>
            <div></div>
            <div></div>
            <?php
            $fila=count($salon);
            ...
            while ($fila>$contador){
                for ($i=1; $i < 2; $i++) { 
                     echo "<div class='contenido'>".$salon[$contador][$i]."</div>";
                    
                }
                print_r("<button type='button' class='botones-tabla' onclick='UpdateSalon(`".$salon[$contador][0]."`,`".$salon[$contador][1]."`)'>Modificar</button>");
                print_r("<button type='button' class='botones-tabla' onclick='EliminarSalon(`".$salon[$contador][0]."`)'>Eliminar</button>");
                $contador=$contador+1;
            }
            
            ?>
        </div>
        <button type='button' class='agregar_actividad' id='agregar_salon'>Agregar Salon</button>
    </div>
            ...
            while ($fila>$contador){
                for ($i=0; $i < 14; $i++) {
                    if ($i==5 || $i==6 || $i==4 || $i==8) {
                        ...
                        $clase_fila=count($clase);
                        $clase_contador=0;
                        $equipo_inv=explode(",",$prestamoRechazado[$contador][$i]);
                        $count=count($equipo_inv);
                        $agrupar_equipo="";
                        $cantidad=explode(",",$prestamoRechazado[$contador][8]);
                        $total_equipo="";
                        $n=0;
                        echo "<div class='contenido'>";
                        while($count>$n) {
                        ...
                        echo $agrupar_equipo;
                        $prestamoRechazado[$contador][$i]=$agrupar_equipo;
                        echo "</div>";
                    }
                    else if($i>8 && $i<12){
                        if ($i==9) {
    ...
    <div class='asigar_equipo' style='top:100px;transform: translate(-50%,0%);width:700px;'>
        ...
        <input type="text" id='cedula_solicitante' name='cedula_solicitante' hidden>
        <input type="text" id='fecha_aprobado' name='fecha_aprobado' hidden>
        <input type="text" id='equipo_aprobado' name='equipo_aprobado' hidden>
        ...
        <label for="" style='font-size:20px;'>Equipo Solicitado</label><br>
        <div class='equipo_asignado' style='display:flex;flex-direction:row;font-size:19px;font-weight:bold;'></div><br><br>
